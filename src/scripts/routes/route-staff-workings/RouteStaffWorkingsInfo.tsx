...
export interface StaffWorkingsParams {
...
export const routeWorkingSchedulerInfo: RouteInfo = {
    path: `/staff-workings/:${nameof<StaffWorkingsParams>(o => o.staffId)}`,
    title: 'Lịch làm việc',
...
export const getStaffWokingsUrl = (params: StaffWorkingsParams) => {
    return routeWorkingSchedulerInfo.path.replace(
        `:${nameof<StaffWorkingsParams>(o => o.staffId)}`, params.staffId
    );
};